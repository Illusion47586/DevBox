...
- Image skills include selected `skills.sh` registry skills plus local `skills/`; they must be available in `/root/.codex/skills`, `/root/.agents/skills`, and `/root/.claude/skills`.
